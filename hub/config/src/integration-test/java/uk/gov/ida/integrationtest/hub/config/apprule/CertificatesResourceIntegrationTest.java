...
public class CertificatesResourceIntegrationTest {
    ...
    private static final SignatureVerificationCertificate BAD_SIGNATURE_CERTIFICATE = aSignatureVerificationCertificate()
            .withX509(BAD_CERTIFICATE_VALUE).build();
    private static final EncryptionCertificate BAD_ENCRYPTION_CERTIFICATE = anEncryptionCertificate()
            .withX509(BAD_CERTIFICATE_VALUE).build();
