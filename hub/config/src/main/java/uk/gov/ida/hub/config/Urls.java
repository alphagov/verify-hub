...
public interface Urls {
    ...
    */
    ...
    interface ConfigUrls {
        ...
        String SINGLE_IDP_ENABLED_TRANSACTIONS_LIST_PATH = TRANSACTIONS_ROOT + "/single-idp-enabled-transactions-list";
        String TRANSACTIONS_FOR_SERVICE_LIST_PATH = "/for-service-list";
