...
public interface Urls {
    ...
    */
    ...
    interface ConfigUrls {
        ...
        String IS_EIDAS_PROXY_NODE_ENABLED_FOR_TRANSACTION_PATH = ENTITY_ID_PATH_PARAM + "/eidas-proxy-node";
        String IS_EIDAS_PROXY_NODE_ENABLED_FOR_TRANSACTION_RESOURCE = TRANSACTIONS_ROOT + IS_EIDAS_PROXY_NODE_ENABLED_FOR_TRANSACTION_PATH;
