...
public interface Urls {
    ...
    */
    ...
    interface ConfigUrls {
        ...
        String ENABLED_IDENTITY_PROVIDERS_PARAM_PATH = ENTITY_ID_PATH_PARAM + "/enabled"; //deprecated
        String ENABLED_IDENTITY_PROVIDERS_PARAM_PATH_RESOURCE = IDENTITY_PROVIDER_ROOT + ENABLED_IDENTITY_PROVIDERS_PARAM_PATH; // deprecated
        String ENABLED_ID_PROVIDERS_FOR_LOA_PATH = ENTITY_ID_PATH_PARAM + LEVEL_OF_ASSURANCE_PATH_PARAM + "/enabled";
