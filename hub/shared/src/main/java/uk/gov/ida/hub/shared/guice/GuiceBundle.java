...
public class GuiceBundle<T extends Configuration> implements ConfiguredBundle<T> {
    ...
    private GuiceBridgeFeature component;
    ...
    public Optional<Injector> getInjector() {
        return Optional.ofNullable(component).map(GuiceBridgeFeature::getInjector);
    }
    ...
    private Module dropwizardModule(T configuration, Environment environment) {
        return binder -> {
            ...
            binder.bindListener(Matchers.any(), new DropwizardServiceBinder(environment));
