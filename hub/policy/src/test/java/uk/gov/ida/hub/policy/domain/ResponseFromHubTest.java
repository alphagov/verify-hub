...
public class ResponseFromHubTest {
    ...
    public void setUp() throws Exception {
        responseFromHub = new ResponseFromHub(
            ...
            Collections.singletonList(MATCHING_SERVICE_ASSERTION),
            RELAY_STATE,
    ...
    public void getMatchingServiceAssertion() {
        assertThat(responseFromHub.getAssertions()).isEqualTo(MATCHING_SERVICE_ASSERTION);
    }
    ...
    public void testToString() {
        ...
        sb.append(",matchingServiceAssertion=").append(responseFromHub.getAssertions());
