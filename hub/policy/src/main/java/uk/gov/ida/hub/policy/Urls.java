...
public interface Urls {
    ...
    */
    ...
    interface ConfigUrls {
        ...
        String ENABLED_ID_PROVIDERS_FOR_LOA_IDP_AUTHN_REQUEST_PATH = ENTITY_ID_PATH_PARAM + LEVEL_OF_ASSURANCE_PATH_PARAM + "/registration-authn-request" + ENABLED_IDENTITY_PROVIDERS_PATH;
        String ENABLED_ID_PROVIDERS_FOR_REGISTRATION_AUTHN_REQUEST_RESOURCE = IDENTITY_PROVIDER_ROOT + ENABLED_ID_PROVIDERS_FOR_LOA_IDP_AUTHN_REQUEST_PATH;
        String ENABLED_ID_PROVIDERS_FOR_LOA_IDP_RESPONSE_PATH = ENTITY_ID_PATH_PARAM + LEVEL_OF_ASSURANCE_PATH_PARAM + "/registration-authn-response" + ENABLED_IDENTITY_PROVIDERS_PATH;
        String ENABLED_ID_PROVIDERS_FOR_REGISTRATION_AUTHN_RESPONSE_RESOURCE = IDENTITY_PROVIDER_ROOT + ENABLED_ID_PROVIDERS_FOR_LOA_IDP_RESPONSE_PATH;
