...
public abstract class MatchRequestSentStateController<T extends MatchRequestSentStateTransitional> extends AbstractMatchRequestSentStateController<T, SuccessfulMatchState> {
