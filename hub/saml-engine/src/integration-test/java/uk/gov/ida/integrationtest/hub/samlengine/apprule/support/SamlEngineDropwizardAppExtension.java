...
public class SamlEngineDropwizardAppExtension extends DropwizardAppExtension  {
    ...
    public SamlEngineDropwizardAppExtension(Class applicationClass, @Nullable String configPath, ConfigOverride... configOverrides) {
    ...
    public static class SamlEngineAppExtensionBuilder {
        ...
        public SamlEngineDropwizardAppExtension build() {
            try {
                redis.before();
            ...
            return new SamlEngineDropwizardAppExtension(
