...
def build_debian_package(build_number, service_path, service_name, package_name)
  ...
  FileUtils.cp("#{PROJECT_ROOT}/debian/#{package_name}/#{package_name}.yml", "deb/ida/#{package_name}/#{package_name}.yml") if File.exist?("#{PROJECT_ROOT}/debian/#{package_name}/#{package_name}.yml")
